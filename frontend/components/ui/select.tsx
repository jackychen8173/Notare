...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("pointer-events-none -mx-1 my-1 h-[0.5px] bg-border", className)}
      {...props}
    />
  )
}
